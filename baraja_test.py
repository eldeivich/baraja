...
class BarajaTest(unittest.TestCase):
    ...
    def test_crear_baraja(self):
        ...
        self.assertEqual(b, ['Ao', '2o', '3o', '4o', '5o', '6o', 'So', 'Co', 'Ro', 'Ac', '2c', '3c', '4c', '5c', '6c', 'Sc', 'Cc', 'Rc', 'Ae', '2e', '3e', '4e', '5e', '6e', 'Se', 'Ce', 'Re', 'Ab', '2b', '3b', '4b', '5b', '6b', 'Sb', 'Cb', 'Rb'])

        self.assertEqual(b[0], 'Ao')
        self.assertEqual(b[39], 'Rb')
        self.assertEqual(b[10], 'Ac')
        self.assertEqual(b[20], 'Ao')
    ...
    def test_mezclar_lista(self):
        ...
        mezclada = ['A', 'C', 'D', 'E','B']
        b = baraja.mezclar(b)
        self.assertEqual(baraja.mezclar(b), mezclada)
